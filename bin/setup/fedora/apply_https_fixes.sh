...
#
# Apply the two Fedora audit warnings on a live system:
#   1. a2enconf other-vhosts-access-log
#   2. Enable local HTTPS (self-signed) for earth.love
#
...
echo '-- Install local HTTPS vhosts (Fedora localhost.crt)'
