...
#*******************************************************************************
#
# elBUILD_root.pl   <Web_Domain>   [<ROOTWORD>]   ["Root Description"]
#
# Purpose:
...
#
#   ex)
#       perl elBUILD_root.pl doms.earth _ROOT "Default Root Directory"
#
# Parameters:
#   <Web_Domain>
...
if (-e $DomainConfig) {
  ...
  if (-d $DomainDir) {
    print "==> elBUILD_root: DomainDir: $DomainDir\n";
  } else {
...
sub BuildUsage
{
  ...
  print "   ex)\n";
  print "       perl elBUILD_root.pl doms.earth _ROOT \"Default Root Directory\"\n\n";
