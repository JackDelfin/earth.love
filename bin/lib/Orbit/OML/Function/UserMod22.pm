...
#*****************************************************************************************
#*
#* Orbit::OML::Function::UserMod22
#*
#* - Implements Orbit Markup Language (OML) for UserMod22 Functions
...
#*****************************************************************************************
# LoadFunctionGroup22
#   - Load the UserMod22 OML Functions
#
# FUNCTION1
# FUNCTION2
#
...
sub Orbit::LoadFunctionGroup22
{
  ...
  #$O->{_OML_FUNCTIONS}->{'FUNCTION22'} = sub { $O->omlFUNCTION22(), };
  #$O->{_OML_FUNCTIONS}->{'FUNCTION22B'} = sub { $O->omlFUNCTION22B(), };

  # EXAMPLE TOKEN MODIFIER - token modifiers are in LOWERcase
  #$O->{_TOKEN_MODIFIERS}->{'func22'}    = sub { $O->modFUNC22(), };
...
#--   - Description
#--
#-- Call: #FUNCTION22[arg1][arg2][arg3]#
#-----------------------------------------------------------------------------
#sub Orbit::omlFUNCTION22
#{
#  my ($self) = @_;
...
#END Orbit::OML:Function::UserMod22
