...
#*****************************************************************************************
#*
#* Orbit::OML::Function::UserMod26
#*
#* - Implements Orbit Markup Language (OML) for UserMod26 Functions
...
#*****************************************************************************************
# LoadFunctionGroup26
#   - Load the UserMod26 OML Functions
#
# FUNCTION1
# FUNCTION2
#*****************************************************************************************
...
sub Orbit::LoadFunctionGroup26
{
  ...
  #$O->{_OML_FUNCTIONS}->{'FUNCTION26'} = sub { $O->omlFUNCTION26(), };
  #$O->{_OML_FUNCTIONS}->{'FUNCTION26B'} = sub { $O->omlFUNCTION26B(), };

  # EXAMPLE TOKEN MODIFIER - token modifiers are in LOWERcase
  #$O->{_TOKEN_MODIFIERS}->{'func26'}    = sub { $O->modFUNC26(), };
...
#--   - Description
#--
#-- Call: #FUNCTION26[arg1][arg2][arg3]#
#-----------------------------------------------------------------------------
#sub Orbit::omlFUNCTION26
#{
#  my ($self) = @_;
...
#END Orbit::OML:Function::UserMod26
