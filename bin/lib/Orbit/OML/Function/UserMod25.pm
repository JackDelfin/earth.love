...
#*****************************************************************************************
#*
#* Orbit::OML::Function::UserMod25
#*
#* - Implements Orbit Markup Language (OML) for UserMod25 Functions
...
#*****************************************************************************************
# LoadFunctionGroup25
#   - Load the UserMod25 OML Functions
#
# FUNCTION1
# FUNCTION2
#*****************************************************************************************
...
sub Orbit::LoadFunctionGroup25
{
  ...
  #$O->{_OML_FUNCTIONS}->{'FUNCTION25'} = sub { $O->omlFUNCTION25(), };
  #$O->{_OML_FUNCTIONS}->{'FUNCTION25B'} = sub { $O->omlFUNCTION25B(), };

  # EXAMPLE TOKEN MODIFIER - token modifiers are in LOWERcase
  #$O->{_TOKEN_MODIFIERS}->{'func25'}    = sub { $O->modFUNC25(), };
...
#--   - Description
#--
#-- Call: #FUNCTION25[arg1][arg2][arg3]#
#-----------------------------------------------------------------------------
#sub Orbit::omlFUNCTION25
#{
#  my ($self) = @_;
...
#END Orbit::OML:Function::UserMod25
