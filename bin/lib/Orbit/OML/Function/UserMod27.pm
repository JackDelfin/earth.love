...
#*****************************************************************************************
#*
#* Orbit::OML::Function::UserMod27
#*
#* - Implements Orbit Markup Language (OML) for UserMod27 Functions
...
#*****************************************************************************************
# LoadFunctionGroup27
#   - Load the UserMod27 OML Functions
#
# FUNCTION1
# FUNCTION2
#*****************************************************************************************
...
sub Orbit::LoadFunctionGroup27
{
  ...
  #$O->{_OML_FUNCTIONS}->{'FUNCTION27'} = sub { $O->omlFUNCTION27(), };
  #$O->{_OML_FUNCTIONS}->{'FUNCTION27B'} = sub { $O->omlFUNCTION27B(), };

  # EXAMPLE TOKEN MODIFIER - token modifiers are in LOWERcase
  #$O->{_TOKEN_MODIFIERS}->{'func27'}    = sub { $O->modFUNC27(), };
...
#--   - Description
#--
#-- Call: #FUNCTION27[arg1][arg2][arg3]#
#-----------------------------------------------------------------------------
#sub Orbit::omlFUNCTION27
#{
#  my ($self) = @_;
...
#END Orbit::OML:Function::UserMod27
